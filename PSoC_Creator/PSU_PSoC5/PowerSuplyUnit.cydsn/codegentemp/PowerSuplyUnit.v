...
module ADC_DelSig_v3_20_0 (
	...
	cy_clock_v1_0
		#(.id("a47dba34-de8c-4185-8efc-0be2aa159e74/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("a47dba34-de8c-4185-8efc-0be2aa159e74/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("4016064257.02811"),
		  .is_direct(0),
		  .is_digital(0))
		theACLK
		 (.clock_out(Net_250));
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("3bf04d40-a28f-4a0d-8c41-b0c3bda75d0f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    ADC_DelSig_v3_20_0 ADC_DelSig_2 (
        .vplus(Net_145),
        .vminus(Net_146),
        .soc(1'b1),
        .eoc(Net_148),
	...
	cy_psoc3_pins_v1_10
		#(.id("0907fe89-8060-4667-9a10-9178a3cd881a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f25fa34c-d17b-4aab-8ec9-d34201af4c8e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a7003ebc-1f74-4844-888a-abdce4669a2a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
