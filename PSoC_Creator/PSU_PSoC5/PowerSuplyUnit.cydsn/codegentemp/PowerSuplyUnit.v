...
module top ;
    ...
    defparam Buttons.Bit4Mode = 0;
    defparam Buttons.Bit5Mode = 0;
    ...
    QuadDec_v3_0_8 MultiJog (
        .quad_A(Net_10747),
        .quad_B(Net_10748),
        .index(1'b0),
        .clock(Net_10753),
        .interrupt(Net_10751));
    defparam MultiJog.CounterResolution = 2;
